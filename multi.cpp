/*
	Arthur Koehl			multi.cpp		February 2016
	...
	this program:
		...
		[2] for each set of parameters:
			...
			(b) draws the keypoints over the image using opencv circle function
...
void read_parameters (string param, int minhessian[], int octaves[], int layers[], int *n);
...
/* ===============================================================================================
  ...
  if (argc < 2)
  {
    cout << "./multi.exe -i input -o output -p paramfile -s scale" << endl;
    return -1;
  }
...
/* ===============================================================================================
   ...
   =============================================================================================== */
  int minhessian[10], octaves[10], layers[10];
  int n;
  read_parameters (param, minhessian, octaves, layers, &n);
...
/* 	==========================================================================================
	Detect Keypoints on the image based on this detector
   	========================================================================================== */
...
void read_parameters (string param, int minhessian[], int octaves[], int layers[], int *n)
{
  ...
  while (infile >> minhessian[i] >> octaves[i] >> layers[i])
  {
    i = i + 1;
  }
